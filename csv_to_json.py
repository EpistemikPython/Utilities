...
#
# csv_to_json.py
#   -- convert a CSV file to a JSON file with proper new lines and indents
#
...
DEFAULT_INDENT = 4
MAX_INDENT = 16
USAGE = f"Usage: python3 {get_base_filename(argv[0])} 'path to CSV file' <indent, DEFAULT = {DEFAULT_INDENT}>"
...
def run():
    ...
    print(f"new {JSON_LABEL} file = {save_to_json(get_base_filename(csv_file), json_data = rows, indt = jndent)}" )
